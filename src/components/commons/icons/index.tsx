...
export const Logo = () => (
    <BiSolidInvader className="w-16 h-16 mx-auto text-purple-300 mb-4 transform hover:scale-110 transition-transform duration-200 hover:rotate-3" />
);

export const ShowPasswordIcon = () => <FiEye size={20} />;
export const HidePasswordIcon = () => <FiEyeOff size={20} />;
